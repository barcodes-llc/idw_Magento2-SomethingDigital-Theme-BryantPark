...
define([
  ...
  $.widget('mage.menu', $.ui.menu, {
    options: {
      ...
      hideDelay: 300,
      delay: 300,
      mediaBreakpoint: '(max-width: 880px)',
    },

    _open: function (submenu) {
      this._super(submenu);
      this.element.trigger('opensubmenu', [submenu]); // triggered once a submenu opens
    },
    ...
    _keydown: function(event) {
      ...
      if (
        this.active.closest(this.options.menus).attr('aria-expanded') != 'true'
      ) {
  ...
  $.widget('mage.navigation', $.mage.menu, {
    ...
    _init: function() {
      ...
      this.element.addClass('ui-menu-responsive').attr('responsive', 'main');
